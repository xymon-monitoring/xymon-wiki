...
The encryption and usernaam/password is not maintained within the xymon software but is the responsibility of the webserver hosting the xymoncgimsg.cgi script.

## Client support

The [XymonPSClient](clients/windows-powershell/overview.md) jas built-in support for this.

For Unix (tested on AIX & Linux), wget and curl drop-in replacement scrtips for the xymon binary are available [here](https://github.com/StefCoene/xymon/).
